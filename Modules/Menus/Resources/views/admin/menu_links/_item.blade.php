<li id="list_{{ $menu_link->id }}" class="" role="menuitem">
    <div class="box">
        ...
        <div class="pull-right">
            <div class="btn-group">
                <a href="{{ route('admin.menus.menu_links.edit',[$menu_link->menu->id,$menu_link->id]) }}" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> </a>
                <a href="{{ route('ajax.menu_links.destroy',$menu_link->id) }}" class="btn btn-default btn-xs delete-me" data-confirm="{{trans('core::global.delete_record')}}"><i class="fa fa-trash"></i> </a>
            </div>
        </div>
