<?php namespace Modules\Banks\Http\Controllers;

use Modules\Core\Http\Controllers\BaseAdminController;
use Modules\Banks\Http\Requests\FormRequest;
use Modules\Banks\Repositories\BankInterface as Repository;
...
class BanksController extends BaseAdminController {
    ...
    public function edit(Bank $model)
        {
    ...
    public function update(Bank $model,FormRequest $request)
    {
        $data = $request->all();
