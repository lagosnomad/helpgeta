...
use Modules\Testimonials\Repositories\EloquentTestimonial;
...
class TestimonialsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Testimonials\Repositories\TestimonialInterface', function (Application $app) {
            $repository = new EloquentTestimonial(new Testimonial);
            return $repository;
        });

        /*$app->view->composer('testimonials::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('testimonials');
        });*/
    }
