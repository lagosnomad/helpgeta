...
use Modules\Reports\Repositories\EloquentReport;
...
class ReportsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Reports',
            'Modules\Reports\Facades\Facade'
        );

        /*Report::observe(new SlugObserver());
        Report::observe(new FileObserver());*/
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Reports\Repositories\ReportInterface', function (Application $app) {
            $repository = new EloquentReport(new Report);
            return $repository;
        });

        /*$app->view->composer('reports::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('reports');
        });*/
    }
