...
use Modules\Banks\Repositories\EloquentBank;
...
class BanksServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Banks',
            'Modules\Banks\Facades\Facade'
        );

        /*Bank::observe(new SlugObserver());
        Bank::observe(new FileObserver());*/
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Banks\Repositories\BankInterface', function (Application $app) {
            $repository = new EloquentBank(new Bank);
            return $repository;
        });

        /*$app->view->composer('banks::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('banks');
        });*/
    }
