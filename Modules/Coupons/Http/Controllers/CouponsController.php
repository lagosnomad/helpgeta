<?php namespace Modules\Coupons\Http\Controllers;

use Modules\Core\Http\Controllers\BaseAdminController;
use Modules\Coupons\Http\Requests\FormRequest;
use Modules\Coupons\Repositories\CouponInterface as Repository;
...
class CouponsController extends BaseAdminController {
    ...
    public function edit(Coupon $model)
        {
    ...
    public function update(Coupon $model,FormRequest $request)
    {
        $data = $request->all();
